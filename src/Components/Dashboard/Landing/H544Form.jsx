...
const H544Form = ({ onSubmit }) => {
  ...
  // Submit the form and pass the patientId to parent
  const handleSubmit = () => {
    if (formData.patientId) {
      onSubmit(formData.patientId); // Pass patientId on submit to parent
    } else {
  ...
  return (
    <div className="w-2/3 p-6 bg-white rounded-lg shadow-md mt-6 mb-10 ">
      ...
      <div className="grid grid-cols-1 text-start mt-1 md:grid-cols-2 gap-4">
        <div>
      ...
      <div className="grid grid-cols-1 text-start mt-1 md:grid-cols-4 gap-4">
        <div>
      ...
      <button
        ...
        className="bg-green-500 text-white px-4 mt-5  py-2 rounded-lg hover:bg-green-600"
      >
        Submit H544 Form
      </button>
    </div>
